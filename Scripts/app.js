/**
 * File Name : app.js
 * @author : Abhinav SHrda
 * Dtae modified : 22 june,2016
 * student ID : 300868625
 * website : COMP125-S2016-midterm
...
"use strict";
   ...
   var points = []
    points[0] = document.getElementById('IntroParagraph' /n 'para1' /n 'para2');
    points[1] = document.getElementById('Folegandros');
    points[2] = document.getElementById('Alonissos');
    points[3] = document.getElementById('Spetses');
    points[4] = document.getElementById('Amorgos');
    points[5] = document.getElementById('Syros');
    points[6] = document.getElementById('Milos');
    points[7] = document.getElementById('Hydra');
    points[8] = document.getElementById('Ithaca');
    points[9] = document.getElementById('Gavdos');
    for (var i = 0; i < points.length; i++) {
        
        if (points[i]){
            points[i].textContent = write[i];}} 
 ...
 //  creating a refrence link for all required feilds.
   ...
   // A refrence form to thr main contac form and depictin gtheir values
